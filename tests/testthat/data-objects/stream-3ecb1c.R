structure(list(method = "GET", url = "/stream?logical-path=%2FtempZone%2Fhome%2Frods%2Ftestthat%2Ffoo.csv&offset=0&count=1000", 
    status_code = 200L, headers = structure(list(Server = "nginx/1.23.1", 
        Date = "Tue, 08 Nov 2022 07:47:52 GMT", `Content-Length` = "16", 
