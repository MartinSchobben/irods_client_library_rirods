structure(list(method = "DELETE", url = "/logicalpath?logical-path=%2FtempZone%2Fhome%2Frods%2Ftestthat%2Ffoo.rds&no-trash=1&recursive=0", 
    status_code = 200L, headers = structure(list(Server = "nginx/1.23.1", 
        Date = "Tue, 13 Jun 2023 19:41:46 GMT", `Content-Length` = "0", 
