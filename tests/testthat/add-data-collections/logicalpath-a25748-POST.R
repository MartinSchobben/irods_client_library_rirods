structure(list(method = "POST", url = "/logicalpath?logical-path=%2FbobZone%2Fhome%2Fmartin%2Ftestthat%2Fx%2Fa&collection=1&create-parent-collections=1", 
    status_code = 200L, headers = structure(list(Server = "nginx/1.18.0 (Ubuntu)", 
        Date = "Sat, 06 May 2023 13:13:29 GMT", `Content-Length` = "0", 
