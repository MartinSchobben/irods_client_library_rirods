structure(list(method = "POST", url = "/logicalpath?logical-path=%2FtempZone%2Fhome%2Frods%2Ftestthat%2Fx%2Fa&collection=1&create-parent-collections=1", 
    status_code = 200L, headers = structure(list(Server = "nginx/1.23.1", 
        Date = "Wed, 14 Jun 2023 08:24:16 GMT", `Content-Length` = "0", 
