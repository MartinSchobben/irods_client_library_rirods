structure(list(method = "DELETE", url = "/logicalpath?logical-path=%2FtempZone%2Fhome%2Frods%2Ftestthat%2Fmt.csv&no-trash=1&recursive=0", 
    status_code = 200L, headers = structure(list(Server = "nginx/1.23.1", 
        Date = "Wed, 14 Jun 2023 08:03:48 GMT", `Content-Length` = "0", 
