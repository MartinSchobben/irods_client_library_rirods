structure(list(method = "DELETE", url = "/logicalpath?logical-path=%2FbobZone%2Fhome%2Fmartin%2Ftestthat%2Ftest.rds&no-trash=0&recursive=0", 
    status_code = 200L, headers = structure(list(Server = "nginx/1.18.0 (Ubuntu)", 
        Date = "Sat, 06 May 2023 12:55:16 GMT", `Content-Length` = "0", 
