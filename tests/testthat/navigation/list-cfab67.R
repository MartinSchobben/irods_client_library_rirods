structure(list(method = "GET", url = "/list?logical-path=%2FbobZone%2Fhome%2Fmartin%2Fprojecty&stat=0&permissions=0&metadata=0&offset=0&limit=100", 
    status_code = 400L, headers = structure(list(Server = "nginx/1.18.0 (Ubuntu)", 
        Date = "Sat, 06 May 2023 13:13:42 GMT", `Content-Length` = "104", 
