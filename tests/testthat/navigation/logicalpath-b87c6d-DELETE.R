structure(list(method = "DELETE", url = "/logicalpath?logical-path=%2FtempZone%2Fhome%2Frods%2Fprojectx%2Ftest.rds&no-trash=1&recursive=0", 
    status_code = 200L, headers = structure(list(Server = "nginx/1.23.1", 
        Date = "Thu, 01 Jun 2023 18:14:33 GMT", `Content-Length` = "0", 
