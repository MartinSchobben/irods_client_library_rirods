structure(list(method = "DELETE", url = "/logicalpath?logical-path=%2FtempZone%2Fhome%2Frods%2Ftestthat%2Ftest.rds&no-trash=1&recursive=0", 
    status_code = 200L, headers = structure(list(Server = "nginx/1.23.1", 
        Date = "Fri, 09 Jun 2023 05:17:59 GMT", `Content-Length` = "0", 
